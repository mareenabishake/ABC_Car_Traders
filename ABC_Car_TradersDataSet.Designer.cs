...
namespace ABC_Car_Traders {
    ...
    public partial class ABC_Car_TradersDataSet : global::System.Data.DataSet {
        ...
        public partial class CarsDataTable : global::System.Data.TypedTableBase<CarsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CarsRow AddCarsRow(string Make, string Model, int Year, decimal Price) {
...
namespace ABC_Car_Traders.ABC_Car_TradersDataSetTableAdapters {
    ...
    public partial class CarsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Cars] WHERE (([CarID] = @Original_CarID) AND ([Make] = @Origin" +
                "al_Make) AND ([Model] = @Original_Model) AND ([Year] = @Original_Year) AND ([Pri" +
                "ce] = @Original_Price))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cars] ([Make], [Model], [Year], [Price]) VALUES (@Make, @Model" +
                ", @Year, @Price);\r\nSELECT CarID, Make, Model, Year, Price FROM Cars WHERE (CarID" +
                " = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cars] SET [Make] = @Make, [Model] = @Model, [Year] = @Year, [Price] = @Price WHERE (([CarID] = @Original_CarID) AND ([Make] = @Original_Make) AND ([Model] = @Original_Model) AND ([Year] = @Original_Year) AND ([Price] = @Original_Price));
SELECT CarID, Make, Model, Year, Price FROM Cars WHERE (CarID = @CarID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CarID, Make, Model, Year, Price FROM dbo.Cars";
        ...
        public virtual int Delete(int Original_CarID, string Original_Make, string Original_Model, int Original_Year, decimal Original_Price) {
        ...
        public virtual int Insert(string Make, string Model, int Year, decimal Price) {
            if ((Make == null)) {
        ...
        public virtual int Update(string Make, string Model, int Year, decimal Price, int Original_CarID, string Original_Make, string Original_Model, int Original_Year, decimal Original_Price, int CarID) {
            if ((Make == null)) {
                throw new global::System.ArgumentNullException("Make");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Make, string Model, int Year, decimal Price, int Original_CarID, string Original_Make, string Original_Model, int Original_Year, decimal Original_Price) {
            return this.Update(Make, Model, Year, Price, Original_CarID, Original_Make, Original_Model, Original_Year, Original_Price, Original_CarID);
        }
    }
